...
const AppFileInput = ({
  ...
  return (
    ...
    >
      <label className="w-64 flex flex-col items-center p-4 bg-white text-primaryDark rounded-lg shadow-sm tracking-wide uppercase border border-primary cursor-pointer hover:bg-primary hover:text-white">
        <svg
          className="w-8 h-8"
          fill="currentColor"
